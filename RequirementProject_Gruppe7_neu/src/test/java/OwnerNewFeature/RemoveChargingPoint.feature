Feature: Removing AC/DC Charging Points
  ...
  Scenario: Owner successfully removes an AC charging point
    ...
    And the owner receives a confirmation message "AC Charging Point removed successfully."
  ...
  Scenario: Owner successfully removes a DC charging point
    ...
    And the owner receives a confirmation message "DC Charging Point removed successfully."
